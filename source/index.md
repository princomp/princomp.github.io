...
| ⚠ Warning       |
|:---------------------------|
| As of Spring 2026, this resource is (still) under active (re)development. You can [refer to the CSCI-1301 website](https://csci-1301.github.io/) or to the [Fundamentals of Computer Science](https://fundamentals-of-computer-science.github.io/) for additional resources on programming for C# developed at Augusta University. |
