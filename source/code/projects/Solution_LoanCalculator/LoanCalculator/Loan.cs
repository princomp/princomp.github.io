...
class Loan
{
  ...
  public static string TypeOfLoan(char typeP)
  {
    string typeName;
    switch (typeP)
    {
      ...
      case ('o'):
        ...
        break;
      default:
        typeName = "ERROR"; // Just to be on the safe side...
        break;
    }
    return typeName;
  }
  ...
  {
    return "Dear " + name + $", you borrowed {amount:C} at {rate:P} for " + TypeOfLoan(type) + ".";
  }
}
