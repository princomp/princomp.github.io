...
class Program
{
  static void Main(string[] args)
  {
    ...
    Console.WriteLine(
      "Greatest number of consecutive 1s:"
        + myList1.CountSuccessive(1)
    );
    Console.WriteLine(
      "Greatest number of consecutive 5s:"
        + myList1.CountSuccessive(5)
    );
    Console.WriteLine(
      "Greatest number of consecutive 2s:"
        + myList1.CountSuccessive(2)
    );
    Console.WriteLine(
      "Last index of 1:" + myList1.LastIndexOf(1)
    );
    Console.WriteLine(
      "Frequency of 1:" + myList1.Frequency(1)
    );
    ...
    Console.WriteLine(
      "Is 2 in my list? " + myList1.Find(2)
    );
    Console.WriteLine(
      "Is 3 in my list? " + myList1.Find(3)
    );
    Console.WriteLine(
      "Is 4 in my list? " + myList1.Find(4)
    );
    Console.WriteLine(
      "Is 5 in my list? " + myList1.Find(5)
    );
    Console.WriteLine(
      "Is 6 in my list? " + myList1.Find(6)
    );
    myList1.Reverse();
    Console.WriteLine(myList1);
    myList1.RemoveAt(1);
