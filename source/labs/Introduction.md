...
| ❓ Question       |
|:---------------------------|
| We used five different file formats in the text above you may not be familiar with. Along with _markdown_ (`md`), that's six; can you make sure you know them all and know their purposes? Looking them up [on wikipedia](https://www.wikiwand.com/en/articles/List_of_file_formats) and reading the first paragraph of each of their pages can be a good way of getting started! |
...
| Try to understand what "[free software](https://www.wikiwand.com/en/articles/Free_software)" means; is it like coffee (some people say "beer") or like speech? | 
...
[Android](https://www.wikiwand.com/en/articles/Android_(operating_system)#Licensing) is mostly free, and [Linux](https://www.wikiwand.com/en/articles/Linux#Development) distributions are in general completely free.
